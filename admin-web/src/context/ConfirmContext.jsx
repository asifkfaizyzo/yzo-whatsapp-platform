...
const TYPE_CONFIG = {
  ...
  info: {
    ...
    Icon: Info,
    confirmClass:
      "bg-[#125EF2] hover:bg-[#0f4fcc] text-white shadow-blue-200/60",
    ...
    >
      ...
      >
        ...
        <div
          className={`h-1 w-full ${
            state.type === "danger"
              ...
              : "bg-gradient-to-r from-[#125EF2] to-blue-400"
          }`}
        />
        ...
        <div className="px-6 pt-6 pb-5">
          ...
          {/* Title */}
          <h3 className={`text-base font-bold ${cfg.titleColor} mb-1.5`}>
            {state.title}
          </h3>

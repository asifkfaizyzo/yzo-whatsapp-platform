...
// 📊 Bull Board Queue Management Dashboard — SuperAdmin only
app.use('/admin/queues', verifySuperAdmin, serverAdapter.getRouter());
...
app.use('/api2/register',                authLimiter); // covers all /register/* including verify-email

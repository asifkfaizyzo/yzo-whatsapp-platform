  ...
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 
        ...
        .014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 
        2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668
        -.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073
        -1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617
        -6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 
        0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 
...
// ── Social Items ──────────────────────────────────────────────────────────────
const socialItems = [
  { key: "facebook",  label: "Facebook",  Icon: FacebookIcon,  hoverClass: "hover:bg-blue-600"  },
  { key: "instagram", label: "Instagram", Icon: InstagramIcon, hoverClass: "hover:bg-pink-600"  },
  { key: "youtube",   label: "YouTube",   Icon: YoutubeIcon,   hoverClass: "hover:bg-red-600"   },
  { key: "linkedin",  label: "LinkedIn",  Icon: LinkedinIcon,  hoverClass: "hover:bg-blue-500"  },
];

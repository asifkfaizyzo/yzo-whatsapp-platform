  ...
  const reviews = [
    {
      ...
      text: "We send 50K+ WhatsApp messages weekly using WATI. The multi-tenant setup lets us manage all our brands from one dashboard. Incredible tool.",
      rating: 5,
    },
    {
      name: "Priya Sharma",
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-sm">
              See why teams choose WATI for WhatsApp broadcasting.
            </p>
          </div>

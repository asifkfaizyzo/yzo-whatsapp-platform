                ...
                <div className="card p-6 bg-gradient-to-r from-emerald-50/40 via-blue-50/30 to-pink-50/40 border border-slate-100 rounded-3xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 mt-6">
                    ...
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all cursor-pointer select-none flex items-center justify-between ${selectedConnector === "whatsapp"
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0 ${selectedConnector === "whatsapp"
                      ...
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold shrink-0 ${whatsappStatus.isConnected
                            ? "bg-emerald-50 text-emerald-700 border border-emerald-200"
                            : "bg-slate-100 text-slate-500"
                          }`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${whatsappStatus.isConnected
                    ...
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all cursor-pointer select-none flex items-center justify-between ${selectedConnector === "facebook"
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0 ${selectedConnector === "facebook"
                      ...
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold shrink-0 ${metaChannels.facebook.connected
                            ? "bg-emerald-50 text-emerald-700 border border-emerald-200"
                            : "bg-slate-100 text-slate-500"
                          }`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${metaChannels.facebook.connected
                              ? "bg-emerald-500 animate-pulse"
                              : "bg-slate-400"
                            }`}
                        />
                    ...
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all cursor-pointer select-none flex items-center justify-between ${selectedConnector === "instagram"
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0 ${selectedConnector === "instagram"
                      ...
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold shrink-0 ${metaChannels.instagram.connected
                            ? "bg-emerald-50 text-emerald-700 border border-emerald-200"
                            : "bg-slate-100 text-slate-500"
                          }`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${metaChannels.instagram.connected
                              ? "bg-emerald-500 animate-pulse"
                              : "bg-slate-400"
                            }`}
                        />
